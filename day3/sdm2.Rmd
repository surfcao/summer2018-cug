---
title: "Day 3: Spatial Point Pattern Analysis II "
...
lgcp <-  rLGCP("exp", 5, var=0.2, scale=.1 )
plot(lgcp)
...
par(mfrow=c(1,2))
plot(pg, main='GLM/logit, raw values')
plot(wrld_simpl, add=TRUE, border='dark grey')
...
# We need to download a jar file from: https://biodiversityinformatics.amnh.org/open_source/maxent/ and put # it into the directory described by 'jar' in the preceding line.
